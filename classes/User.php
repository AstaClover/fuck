...
class User {
	...
	//	global $hide_ids;
		...
		if (($id)) 
		{  
			$msg = "<div class='popup_main'><div class='popup_inner'><i><img src='https://png.icons8.com/ios-glyphs/100/ffffff/multiply.png'></i><img src='$qrcode'> <div class='right_aria'><strong>Secret Key:</strong> $secret *Please write this down and keep in a secure area* <div class='color_box'> Please scan this with the Google Authenticator app on your mobile phone. This page will clear on refresh, please be careful.</div></div></div></div>";
      ...
      function disauth()
    		  ...
    		  if (($id))
     		 {
			$msg = "<div class='popup_main'><div class='popup_inner'><i><img src='https://png.icons8.com/ios-glyphs/100/ffffff/multiply.png'></i>Two Factor Auth has been disabled for your account and will no longer be required when you sign in.</div></div>";
